...
//---------------------CON PROTOTYPE------------------------
  ...
  Usuario.prototype.saludar = function(){return 'Hola, mi nombre es ' + this.nombre };
                         // Con comillas iunvertidas --> `Hola, mi nombre es ${this.nombre}`
  return Usuario;
//------------------------CON CLASE---------------------------
/*
  class Usuario{
    ...
    saludar = function(){
      return 'Hola, mi nombre es ' + this.nombre}; //esta clase de metodos ocuparan memoria
  }
  return Usuario;
  */
...
function agregarStringInvertida() {
  ...
  String.prototype.reverse = function(){
    ...
    for(var i = this.length-1; i >= 0;i--){
      newstr += this.charAt(i);// tambien con '' this[i] ''
    }
    return newstr;
  }
}
